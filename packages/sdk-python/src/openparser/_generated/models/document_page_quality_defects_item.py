...
T = TypeVar("T", bound="DocumentPageQualityDefectsItem")



@_attrs_define
class DocumentPageQualityDefectsItem:
    """
        Attributes:
            type_ (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_page_quality_defects_item = cls(
            type_=type_,
            confidence=confidence,
        )

        return document_page_quality_defects_item
