...
T = TypeVar("T", bound="LineageDocumentAgents")
...
class LineageDocumentAgents:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lineage_document_agents.additional_properties = additional_properties
        return lineage_document_agents

    @property
    def additional_keys(self) -> list[str]:
        return list(self.additional_properties.keys())

    def __getitem__(self, key: str) -> LineageAgent:
        return self.additional_properties[key]

    def __setitem__(self, key: str, value: LineageAgent) -> None:
