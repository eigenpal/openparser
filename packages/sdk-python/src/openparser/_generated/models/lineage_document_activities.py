...
T = TypeVar("T", bound="LineageDocumentActivities")
...
class LineageDocumentActivities:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lineage_document_activities.additional_properties = additional_properties
        return lineage_document_activities

    @property
    def additional_keys(self) -> list[str]:
        return list(self.additional_properties.keys())

    def __getitem__(self, key: str) -> LineageActivity:
        return self.additional_properties[key]

    def __setitem__(self, key: str, value: LineageActivity) -> None:
