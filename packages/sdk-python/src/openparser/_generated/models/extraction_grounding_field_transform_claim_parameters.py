...
T = TypeVar("T", bound="ExtractionGroundingFieldTransformClaimParameters")
...
class ExtractionGroundingFieldTransformClaimParameters:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        extraction_grounding_field_transform_claim_parameters = cls(
        )
        ...
        extraction_grounding_field_transform_claim_parameters.additional_properties = additional_properties
        return extraction_grounding_field_transform_claim_parameters
