...
T = TypeVar("T", bound="SignatureElement")
...
class SignatureElement:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        kind = cast(Literal['signature'] , d.pop("kind"))
        if kind != 'signature':
            raise ValueError(f"kind must match const 'signature', got '{kind}'")
